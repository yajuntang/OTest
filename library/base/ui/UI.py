...
from airtest.core.api import touch, wait as airtest_wait, sleep, text, loop_find, swipe as swipe_airtest, \
...
class UI:
    ...
    def setUp(self, poco, is_ios):
        ...
        if self.is_airtest:
            ...
            self.poco_ui = poco(**kw)  # name text  kw = { 'text':'登陆' }
